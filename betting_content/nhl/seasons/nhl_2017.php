<p style="font-weight:bold;">2017 NHL Playoffs bracket</p>
<table>
    <tbody>
        <tr>
            <td>
                <ul class="list-group panel panel-default" style="border:none">
                    ...
                    <li class="list-group-item list-group-item-danger"><strong>Blackhawks</strong> vs Predators (0-4)</li>
                    <li class="list-group-item list-group-item-success">Wild vs <strong>Blues</strong> (1-4)</li>
                    <li class="list-group-item list-group-item-success"><strong>Ducks</strong> vs Flames (4-0)</li>
            ...
            <td>
                <ul class="list-group panel panel-default" style="border:none">
                    ...
                    <li class="list-group-item">Blues vs <strong>Oilers</strong></li>
                    <li class="list-group-item panel-heading">Eastern Conference</li>
                    <li class="list-group-item">Canadiens vs <strong>Capitals</strong></li>
                </ul>
            </td>
            <td>
                <ul class="list-group panel panel-default" style="border:none">
                    <li class="list-group-item panel-heading">Stanley Cup Champion</li>
                    <li class="list-group-item">Oilers vs <strong>Capitals</strong></li>
                </ul>
            </td>
        </tr>
    </tbody>
